describe AlarmSounder do
  ...
  it 'should turn the lights to high, start leap motion tracking and start playing audio on timer fire' do
    @lights_mock.mock!(:turn_high)
